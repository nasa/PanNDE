...
def main():
    ...
    laminate_geometry = {
        "lamiant_dimensions": np.array([15e-3, 15e-3]), 
        "cell_dimensions": np.array([0.3e-3, 0.3e-3, 0.06e-3]), 
        "ply_thickness": 0.12e-3, 
        "ply_orientations": np.array([0])}
    ...
    transducer =  {
        ...
        "cycle_count": 5, 
        "phase": 0, 
        "location": np.array([7.5e-3, 7.5e-3, 0.12e-3])}
